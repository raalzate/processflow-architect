...
Cinco features con artefactos acá: `001-layout-legible`, `002-layout-organizar`,
`003-ui-homogenea`, `004-artefactos-versionados` —la primera con el ciclo completo
(`spec` · `plan` · `checklist` · `testify` · `tasks` · `analyze`)— y `005-contexto-react-hitl`,
en curso (por ahora `spec` y `checklist`).
