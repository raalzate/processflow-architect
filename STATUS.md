...
- **Versión publicada:** 0.8.6 — publicada el 2026-09-01, con los 8 artefactos y como `latest` de la API. Es la que arregla el 404 del updater en Windows (#235): `npm run release:updater-check` da ✓ en las tres plataformas contra este release. Antes de ella, 0.8.5 (aviso de actualización en el pie, #231) y 0.8.4 (pegar con ⌘V, #227) también quedaron publicadas; `v0.8.3` y `v0.7.0` quedaron en borrador, superadas
- **Versión en el repo:** 0.8.6 — igual a la publicada (PR #237)
