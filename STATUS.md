...
- **Rama:** `chore/release-0.11.0` (sale a `main` por PR)
- **Veredicto:** VERDE (`npm run gate`)
- **Versión publicada:** 0.10.0 — publicada el 2026-09-08 y `latest` de la API; trae el buscador de la paleta (#295). Antes, 0.9.0 y 0.8.6 (la que arregla el 404 del updater en Windows, #235); `v0.8.3` y `v0.7.0` quedaron en borrador, superadas
- **Versión en el repo:** 0.11.0 — por delante de la publicada: agente constructor (#308 · #332), adjuntos por elemento (feature 016, #360), notación entidad-relación, paleta de formas generales y subprocesos sin pestaña propia (#349). Notas en `docs/releases/0.11.0.md`; el tag `v0.11.0` dispara el empaquetado
