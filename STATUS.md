...
- **En vuelo (rama `feature/012-fuente-y-spec-en-contexto`):** #239 (el agente lee la ficha de la caja: `read_element`, la marca `{spec,props,desc+}` en el digest, `set_element_spec { merge: true }` y un `review_specs` que marca criterios sin número y requisitos con tecnología) y la **feature 012** (#240, tareas #241–#250): el documento fuente viaja dentro del proyecto y la cita de una caja resuelve a su fragmento. Gate completo verde el 2026-09-01; falta el PR y el mergeo
